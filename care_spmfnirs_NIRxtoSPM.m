...
srcPath     = CARE_getopt(cfg, 'srcPath', ...
            '/Volumes/INTENSO/CARE/DualfNIRS_CARE_rawData/');
desPath     = CARE_getopt(cfg, 'desPath', ...
            '/Volumes/INTENSO/CARE/DualfNIRS_CARE_processed/01_spm_fnirs/');
SDfile      = CARE_getopt(cfg, 'SDfile', ...
            '/Volumes/INTENSO/CARE/DualfNIRS_CARE_processed/00_settings/CARE.SD');
...
Sub1DesFile = strcat(desPath, sprintf([prefix, '_d%02da_01_spm_fnirs_'], ...
                      dyadNum), sessionStr, '.mat');
Sub2DesFile = strcat(desPath, sprintf([prefix, '_d%02db_01_spm_fnirs_'], ...
                      dyadNum), sessionStr, '.mat');
